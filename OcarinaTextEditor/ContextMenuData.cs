...
namespace Zelda64TextEditor
{
    public static class ContextMenuData
    {
        ...
        public static string[] GenericTagMajora = new string[] { "(Broken) Text Speed",                  $"{ZeldaMsgPreview.MajoraControlCode.TEXT_SPEED}",             "Meant to be like the OoT TEXT_SPEED tag, but it doesn't work due to a bug.",
                                                                 ...
                                                                 "Delay, then new textbox",              $"{ZeldaMsgPreview.MajoraControlCode.NEW_BOX_DELAY}",          "Inserts a pause in the text, then opens new textbox.",
                                                                 "Delay",                                $"{ZeldaMsgPreview.MajoraControlCode.DELAY}",                  "Inserts a pause in the text.",
                                                                 "Skippable Fade",                       $"{ZeldaMsgPreview.MajoraControlCode.FADE_SKIPPABLE}",         "Waits for the specified number of frames until ending the textbox, but the message can be closed instantly by pressing A.",
                                                                 "Fade",                                 $"{ZeldaMsgPreview.MajoraControlCode.FADE}",                   "Waits for the specified number of frames until ending the textbox.",
