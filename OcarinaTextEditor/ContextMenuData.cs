...
namespace Zelda64TextEditor
{
    public static class ContextMenuData
    {
        ...
        public static string[] GenericTagMajora = new string[] { "Null character",                       $"{MajoraControlCode.NULL_CHAR}",              "Prints nothing, causing the text routine to print out slower.",
                                                                 ...
                                                                 "Delay, then new textbox",              $"{MajoraControlCode.DELAY_NEWBOX}",           "Inserts a pause in the text, then opens new textbox.",
                                                                 "Delay",                                $"{MajoraControlCode.DELAY}",                  "Inserts a pause in the text.",
                                                                 "Delay, then close textbox",            $"{MajoraControlCode.DELAY_END}",              "Inserts a pause in the text before closing the textbox.",
